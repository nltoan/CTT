...
### Backend CMS (Payload)
- **Runtime**: Node.js 20.
- **Database**: MySQL (PlanetScale/Aurora/Render). ORM nội bộ của Payload.
...
- `payload.config.ts` đăng ký toàn bộ collection/globals, kết nối MySQL và plugin cloud storage.
